...
\usepackage{booktabs} % for clean horizontal rules in tables
...
\newcommand{\placeprofilephoto}{%
  \AddToShipoutPictureFG*{%
    \put(
      \LenToUnit{\paperwidth-0.75in-2.5cm},
      \LenToUnit{\paperheight-0.75in-1.9cm}
    ){%
      \begin{tikzpicture}
        \clip (0,0) circle (1.25cm);
        \node at (0,0) {\includegraphics[width=2.5cm, height=2.5cm,
        keepaspectratio]{profile_photo.png}};
      \end{tikzpicture}
    }%
  }%
}%
...
\begin{onecolentry}
  \begin{tabularx}{\textwidth}{@{} X p{7.5cm} r @{}}
    % \toprule
    \textbf{Institution} & \textbf{Degree / Result} & \textbf{Period} \\
    \midrule
    \textbf{Khulna University of Engineering \& Technology}, Khulna-9203,
    Bangladesh & B.Sc.\ in Energy Science and Engineering, CGPA
    2.80/4.00 & 2022 -- 2026 \\
    \textbf{Govt. Science College}, Tejgaon, Dhaka-1215 & Higher Secondary
    Certificate, GPA 5.00/5.00 & 2018 -- 2021 \\
    \textbf{Bright School and College}, Donia, Dhaka-1236 & Secondary School
    Certificate, GPA 5.00/5.00 & 2018 \\
    \midrule
  \end{tabularx}
\end{onecolentry}
...
\begin{onecolentry}
  \small \textit{Notable Coursework: Thermodynamics, Fluid Mechanics, Heat and
    Mass Transfer, Power Plant Engineering, Renewable Energy
    Engineering, IC Engines, HVAC\&R, Engineering Drawing and
  Simulation, Electrical Fundamentals}
\end{onecolentry}
...
\begin{onecolentry}
  \begin{tabularx}{\textwidth}{@{} p{6.5cm} p{8.7cm} X @{}}
    % \toprule
    \textbf{Role / Training} & \textbf{Key
    Experience Gained} & \textbf{Period}  \\
    \midrule
    Industrial Attachment, Karnaphuli Power Ltd, Chattogram &
    Gained hands-on experience operating steam and diesel power-plant
    components, mastering key subsystems. &
    Sep 2024 \\
    \addlinespace
    Training on Occupational Safety, Health \& Environment
    Management, KUET &
    Conducted hazard identification and applied risk-analysis methods
    to improve occupational safety management. &
    May 2024 \\
    \midrule
  \end{tabularx}
\end{onecolentry}
...
\begin{onecolentry}
  \begin{tabularx}{\textwidth}{@{} l X @{}}
    % \toprule
    \textbf{Category} & \textbf{Tools / Competencies} \\
    \midrule
    Engineering Tools \& Software & CAD (SolidWorks, FreeCAD),
    MATLAB, \LaTeX, Linux Environment \\
    Technical \& Data Analysis & NumPy, SciPy, SymPy, Matplotlib,
    Python (predictive modeling), Thermodynamic Analysis (Energy,
    Exergy, Exergoeconomic) \\
    \midrule
  \end{tabularx}
\end{onecolentry}
